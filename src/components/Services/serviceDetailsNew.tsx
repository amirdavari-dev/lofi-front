                            ...
                            return (
                              ...
                              >
                                <Image
                                  width={16}
                                  height={16}
                                  src="/images/services/new-service-details/check.svg"
                                  alt="check icon"
                                />{" "}
                                {about}
                              </li>
              ...
              >
                ...
                <div className="avtar_faces">
                  <Image
                    width={1140}
                    height={470}
                    src="/images/services/new-service-details/comment group.png"
                    alt="image"
                  />
                </div>
              </div>
                            ...
                            <h2 className="mb-0">
                              ...
                              >
                                <Image
                                  ...
                                  width={20}
                                  height={20}
                                  src="/images/services/new-service-details/plus.svg"
                                  data-plus="/images/services/new-service-details/plus.svg"
                                  data-minus="/images/services/new-service-details/minus.svg"
                  ...
                  >
                    <div className="story_img">
                      <Image
                        width={360}
                        height={268}
                        src="/images/services/new-service-details/image.png"
                        alt="Blog Image"
                      />
                  ...
                  >
                    <div className="story_img">
                      <Image
                        width={360}
                        height={268}
                        src="/images/services/new-service-details/image-1.png"
                        alt="image"
                      />
                      <span>45 min ago</span>
                    </div>
                    <div className="story_text">
                      ...
                      <p>
                        ...
                        industry lorem Ipsum has Lorem Ipsum is.
                      </p>
                      <a href="#">READ MORE</a>
                    </div>
                  </div>
                  ...
                  >
                    <div className="story_img">
                      <Image
                        width={360}
                        height={268}
                        src="/images/services/new-service-details/image-2.png"
                        alt="image"
                      />
                      <span>45 min ago</span>
                    </div>
